...
const Vegan = ({ recipes, type }) => {
  const [currentPage, setCurrentPage] = useState(1);
  const [postsPerPage] = useState(15);
  const route = useLocation();
  const status2 = route.pathname === "/list/vegan" ? true : false;
  console.log(status2);
                  ...
                  return (
                    <div key={re.id} className="lg:w-[200px]">
                      <img
                        ...
                        src={
                          VeganP && VeganP[modeIndex] && VeganP[modeIndex].image
                            ? VeganP[modeIndex].image
                            : ""
                        }
                        alt="recipes"
                      />
                      <NavLink to={`/list/vegan/${re.id}/${modeIndex}`}>
